...
//@formatter:off
/*@ $com.tridiumuniversity.multiplexer.BMultiplexer(4228608721)1.0$ @*/
/* Generated Mon Aug 05 22:56:42 MDT 2024 by Slot-o-Matic (c) Tridium, Inc. 2012-2024 */
   ...
   * @see #setIn0
   */
  public static final Property in0 = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setIn1
   */
  public static final Property in1 = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setIn2
   */
  public static final Property in2 = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setIn3
   */
  public static final Property in3 = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setS0
   */
  public static final Property s0 = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setS1
   */
  public static final Property s1 = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setOut
   */
  public static final Property out = newProperty(0, BBoolean.make(false).as(BBoolean.class).getBoolean(), null);
